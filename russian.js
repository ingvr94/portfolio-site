...
let data= {
    russian:{
        ...
        portfolioDescription:['Онлайн магазин мебели','Современное адаптивное приложение для планирования задач','Одностраничное приложение с информацией о тренажерном зале','Веб-приложение с формой авторизации,основной страницей и календарем','Сайт исполнителя с музыкальным плеером'],
