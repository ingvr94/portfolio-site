...
let data= {
    russian:{
        ...
        portfolioTitle:['Приложение-органайзер','Переводчик','Сайт музыкального исполнителя'],
        portfolioDescription:['Современное адаптивное приложение для планирования задач','Перевод русских слов','Сайт с моей музыкой'],
