...
let data= {
    russian:{
        ...
        aboutDesc:'Начинающий Web-разработчик c высоким уровнем мотивации и опытом разработки функциональных и адаптивных веб сервисов.',
        ...
        portfolioTitle:['E-Commerce','Приложение-органайзер','Сайт тренажерного зала','Образовательная платформа','Сайт музыкального исполнителя'],
        portfolioDescription:['Сайт для онлайн заказов мебели','Современное адаптивное приложение для планирования задач','Одностраничное приложение с информацией о тренажерном зале','Веб-приложение с формой авторизации,основной страницей и календарем','Сайт исполнителя с музыкальным плеером'],
